  ...
  return (
    ...
    <td>
      <fetcher.Form method="post">
        ...
        <input type='hidden' name="expenseId" value={expense.id}></input>
        <button type='submit' className='btn btn--warning' aria-label={`Delete ${expense.name}`}><TrashIcon width={20}/></button>
      </fetcher.Form>
    </td>
    </>
  )
